package Levels.veryHard.mergeSortedArrays;
    ...
    public static List<Integer> mergeSortedArrays(List<List<Integer>> arrays) {
        ...
        while (!minHeap.isEmpty()) {
            ...
            if (smallestItem.elementIdx == arrays.get(smallestItem.arrayIdx).size() - 1)
                continue;
            minHeap.insert(new Item(smallestItem.arrayIdx, smallestItem.elementIdx + 1, arrays.get(smallestItem.arrayIdx).get(smallestItem.elementIdx + 1)));
        }
        return sortedList;
    }
